...
export declare const isAlphaKeys: (key: string) => boolean;
...
export declare const isKeyboardEvent: (event: any) => event is React.KeyboardEvent<Element>;
export declare const isHideMenuKey: (key: any) => boolean;

...
export declare type GridFieldComparatorList = {
    field: string;
 ...
 */
export declare type GridComparatorFn = (v1: GridCellValue, v2: GridCellValue, cellParams1: GridCellParams, cellParams2: GridCellParams) => number;
/**
